...
class Trainer:
    def __init__(self, cfg: DictConfig) -> None:
        ...
        if cfg.model_type == 'deim':
            ...
            self.scheduler = FlatCosineLRScheduler(
                self.optimizer,
                lr_gamma=cfg.train.deim.lr_gamma,
                iter_per_epoch=iter_per_epoch,
                total_epochs=cfg.train.epochs,
                warmup_iter=cfg.train.deim.warmup_iter,
                flat_epochs=cfg.train.deim.flat_epoch,
                no_aug_epochs=cfg.train.deim.no_aug_epoch,
            )
    ...
    def train(self) -> None:
        ...
        def optimizer_step(step_scheduler: bool, current_iter: int = 0):
            """
